...
from ..models.inputs import (
    ClosePullRequestInput, CreatePRReviewInput, CreatePullRequestInput, GetPullRequestDetailsInput, GraphQLPROverviewInput, ListPullRequestsInput, MergePullRequestInput,
)
