...
GitHub App authentication provides 3x better rate limits (15,000 vs 5,000 requests/hour) and is the recommended authentication method for production use.

---

## Required Permissions

For all **47 tools** to work with GitHub App authentication, configure these repository permissions:
